...
const ExperiencesDetails = [
    {
        ...
        descriptionList: [
            "Worked with the CameraX team to develop an Android application in Jetpack Compose as part of the Android Open Source Project",
            "Designed the application architecture with Jetpack Compose and developed the application to support core CameraX functionalities such as capturing images, video taking, supporting flash, zoom and tap-to-focus. Integrated MLKit with CameraX to build an in-app QR-Code Scanner",
            "Create integration tests to ensure proper integration of the two libraries",
            "Proposed Compose API to integrate CameraX's PreviewView with Jetpack Compose to reduce engineering effort in integrating the two libraries",
        ],
        technologies: [
            TechMap.android,
